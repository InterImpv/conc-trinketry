...
/* M506 Code BEGIN */
/* Original EasyPen M506 report descriptor size */
#define EASYPEN_M506_RDESC_ORIG_SIZE	476

/* Fixed EasyPen M506 report descriptor */
static __u8 easypen_M506_rdesc_fixed[] = {
    ...
    0x26, 0x00, 0x60, /*      Logical Maximum (24576),    */
    0x81, 0x02,       /*      Input (Variable),           */
    0x09, 0x31,       /*      Usage (Y),                  */
		...
		unsigned int *rsize)
{
	...
	case USB_DEVICE_ID_KYE_EASYPEN_M506:
		if (*rsize == EASYPEN_M506_RDESC_ORIG_SIZE) {
			rdesc = easypen_M506_rdesc_fixed;
			*rsize = sizeof(easypen_M506_rdesc_fixed);
		}
		break;
	/* M506 Code END */
...
static const struct hid_device_id kye_devices[] = {
	...
	{ HID_USB_DEVICE(USB_VENDOR_ID_KYE,	/* M506 Code BEGIN */
				USB_DEVICE_ID_KYE_EASYPEN_M506) },
	{ HID_USB_DEVICE(USB_VENDOR_ID_KYE,	/* M506 Code END */
